...
export async function fetchNewColor() {
  ...
  console.log("🚀  colorData:", colorData.name.closest_named_hex);
  console.log("🚀  colorData:", colorData.name.value);

  const randomColorHex = colorData.name.closest_named_hex;
  const randomColorName = colorData.name.value;

  setColorToGuess(randomColorHex, randomColorName);
  // --^-- your code here --^--
}
