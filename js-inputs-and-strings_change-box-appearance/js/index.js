...
Hint: You may need to work with the CSS property "transform" and a value that contains "rotate"
 and "deg".
...
radiusInput.addEventListener("input", () => {
  let x = radiusInput.value;
  box.style.borderRadius = `${x}px`;
});

rotationInput.addEventListener("input", () => {
  let x = rotationInput.value;
